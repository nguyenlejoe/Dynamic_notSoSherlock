...
function addChoices(){
    ...
    ocument.querySelector("#buttonA").innerHTML =  Clues[0].multiChoice[1];
    ocument.querySelector("#buttonA").innerHTML =  Clues[0].multiChoice[2];
}

addChoices();

console.log(Clues[0].multiChoice[1]);