...
var A = Clues[0].multiChoice[1][1];
var B = Clues[0].multiChoice[1][1];
var C = Clues[0].multiChoice[1][1];
/*console.log(Clues[0].multiChoice[0][1]);
console.log(Clues[0].multiChoice[1][1]);
console.log(Clues[0].multiChoice[2][1]);
*/
